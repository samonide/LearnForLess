                ...
                <TableRow key={user.id}>
                  <TableCell>
                    <div className="flex items-center gap-2">
                      <div className="w-8 h-8 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center shrink-0 border border-border">
                        {user.role === "admin" ? (
                  ...
                  <TableCell className="font-bold text-sm">{enrolledCourses}</TableCell>
          ...
          <SheetContent className="w-full sm:max-w-md overflow-y-auto">
            ...
            <div className="space-y-6 pt-5">
              ...
              <div className="flex items-center gap-3 bg-muted/20 p-4 rounded-lg border border-border">
                <div className="w-10 h-10 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center border border-border shrink-0">
                  ...
                  <div className="space-y-2">
                    {selectedUser.user_courses.map((uc) => {
                      ...
                      return (
                        <div
                          key={uc.course_id}
                          className="border border-border rounded-lg p-3 bg-card flex items-center justify-between gap-3 shadow-sm"
                        >
